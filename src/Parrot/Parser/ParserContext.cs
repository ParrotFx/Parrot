...
namespace Parrot.Parser
{
    ...
    //    // constructor
    //    public ParserContext(GOLD.Parser parser)
    //    {
    //        _parser = parser;
    //    }
    ...
    //        switch (_parser.CurrentToken().Type())
    //        {
    //            case SymbolType.Content:
    //                return _parser.CurrentToken().Data as string;
    ...
    //    public AbstractNode CreateASTNode(Reduction reduction)
    //    {
    ...
    //        RuleConstants rule = (RuleConstants)reduction.Parent.TableIndex();

    //        switch (rule)
    //        {
    //            case RuleConstants.RULE_PARAMETERS_LPARAN_RPARAN:
    ...
    //            case RuleConstants.RULE_PARAMETER_STRINGLITERAL:
    //            case RuleConstants.RULE_PARAMETER_IDENTIFIER:
    ...
    //            case RuleConstants.RULE_PARAMETERLIST2:
    ...
    //            case RuleConstants.RULE_PARAMETERS:
    //                //<Parameter> ::= 
